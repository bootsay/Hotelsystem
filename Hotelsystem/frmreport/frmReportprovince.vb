...
Public Class frmReportprovince
    Dim cn As New connectdb
    Dim da As New SqlDataAdapter
    Dim dt, dt1, dt2 As New DataTable
    Dim cm As New SqlCommand
    Dim markettype As New tbfbookingtype
    Dim cry As New cryReportprovince
    ...
    Private Sub btncry_Click(sender As Object, e As EventArgs) Handles btncry.Click
        Try
            ...
            dt.Clear()
            cn.connect()
            cm = New SqlCommand("select * from viewprovience where countryname like N'%" & subname & "%'ORDER BY countryid ASC", cn.conn)
            With da
                .SelectCommand = cm
                .Fill(dt)
            End With
    ...
    Private Sub ButtonX1_Click(sender As Object, e As EventArgs) Handles ButtonX1.Click
        Try
            ...
            dt.Clear()
            cn.connect()
            cm = New SqlCommand("select * from viewprovience ORDER BY countryid ASC", cn.conn)
            With da
                .SelectCommand = cm
                .Fill(dt)
            End With
