...
Public Class frmReportDeparture
    Dim cn As New connectdb
    Dim da As New SqlDataAdapter
    Dim dt, dt1, dt2 As New DataTable
    Dim cm As New SqlCommand
    Dim markettype As New tbfbookingtype
    Dim cry As New CryReportDeparture
    ...
    Private Sub btncry_Click(sender As Object, e As EventArgs) Handles btncry.Click
        Try
            ...
            dt.Clear()
            cn.connect()
            cm = New SqlCommand("select * from viewcheckout where checkoutdate>='" & Format(CDate(date1.Text), "MM/dd/yyyy") & "'and checkoutdate<='" & Format(CDate(date2.Text), "MM/dd/yyyy") & "' and  bookingtypename like N'%" & subname & "%' and statusid=4  ORDER BY checkoutNO ASC", cn.conn)
            With da
                .SelectCommand = cm
                .Fill(dt)
            End With
