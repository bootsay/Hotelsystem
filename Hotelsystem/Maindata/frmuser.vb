Public Class frmuser
    ...
    Private Sub btnupdatelevel_Click(sender As Object, e As EventArgs) Handles btnupdatelevel.Click
        Try
            ...
            MessageBox.Show("ທ່ານກຳນົດສິດທິສຳເລັດແລ້ວ", "ຜົນການກວດສອບ")
            txtclear()
        Catch ex As Exception
