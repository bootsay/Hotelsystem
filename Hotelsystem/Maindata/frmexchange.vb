Public Class frmexchange
    ...
    Private Sub frmexchange_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            With dgvexchange
                ...
                Dim y As Double = .CurrentRow.Cells(3).Value
                txtchina.Text = ba.ToString("N0")
            End With
    ...
    Private Sub txtchina_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtchina.KeyPress
        Dim FullStop As Char
        FullStop = "."

        ' if the '.' key was pressed see if there already is a '.' in the string
        ' if so, dont handle the keypress
        If e.KeyChar = FullStop And txtchina.Text.IndexOf(FullStop) <> -1 Then
            e.Handled = True
            Return
        End If
