...
Public Class frmbilldetailmoveitem
    ...
    '            txtbillNO.Text = .CurrentRow.Cells(1).Value
    '            txtfrombillNO.Text = .CurrentRow.Cells(2).Value
    '            txtlist.Text = .CurrentRow.Cells(3).Value
