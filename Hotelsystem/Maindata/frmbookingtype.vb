Public Class frmbookingtype
    ...
    Private Sub btnsave_Click(sender As Object, e As EventArgs) Handles btnsave.Click
        ...
        If txttype.Text = "" Then
            ...
            Return
        End If
        bookingtype.save(txtid.Text, txttype.Text)
        txttype.Clear()
        bookingtype.loadtbfbookingtype(dgvshow)
        txtid.Text = bookingtype.runid
        enablesave()
        txttype.Select()
    End Sub

    Private Sub frmbookingtypegory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            txtid.Text = bookingtype.runid
            bookingtype.loadtbfbookingtype(dgvshow)
            enablesave()
    ...
    Private Sub btnupdate_Click(sender As Object, e As EventArgs) Handles btnupdate.Click
        bookingtype.update(txtid.Text, txttype.Text)
        txttype.ReadOnly = False
        txtid.Text = bookingtype.runid
        bookingtype.loadtbfbookingtype(dgvshow)
        txttype.Clear()
