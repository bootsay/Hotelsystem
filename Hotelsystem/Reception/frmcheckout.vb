Public Class frmcheckout
    ...
    Private Sub txtorderNote_TextChanged(sender As Object, e As EventArgs) Handles txtorderNote.TextChanged

    End Sub

    Private Sub dtsale_ValueChanged(sender As Object, e As EventArgs) Handles dtsale.ValueChanged

    End Sub

    Private Sub txtstockoutNO_TextChanged(sender As Object, e As EventArgs) Handles txtstockoutNO.TextChanged
