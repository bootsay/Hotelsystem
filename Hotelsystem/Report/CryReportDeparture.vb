...
Public Class CryReportDeparture
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HotelSystem.CryReportDeparture.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryReportDeparture
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryReportDeparture = New CryReportDeparture()
        rpt.Site = Me.Site
        Return rpt
    End Function
