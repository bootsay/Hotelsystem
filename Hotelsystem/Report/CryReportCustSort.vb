...
Public Class CryReportCustSort
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HotelSystem.CryReportCustSort.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryReportCustSort
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryReportCustSort = New CryReportCustSort()
        rpt.Site = Me.Site
        Return rpt
    End Function
