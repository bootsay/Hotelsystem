...
Public Class cryReportprovince
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HotelSystem.cryReportprovince.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_totalpax() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcryReportprovince
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryReportprovince = New cryReportprovince()
        rpt.Site = Me.Site
        Return rpt
    End Function
